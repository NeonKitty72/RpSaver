...
*
*****************************************************************/
/*global document, DOMParser, CKEDITOR, activateSaveButton*/
var isDebug = true;	//if true, has debug messages. Otherwise does not.
var allText;
...
//loads in a debug string that can be used to quickly debug a certain type of 
function loadDebugText(){
    if (CKEDITOR.instances.rp.getData() !== ""){return;}
    var thingToCheck = 1;
    ...
    document.getElementsByName("messengerRadioList")[thingToCheck].checked = true;
}
...
//******************************************************************************************************************************
//  DECIPHERS AND DECIPHER FUNCTIONS
//******************************************************************************************************************************
//#region   
...
//takes in a function that MUST return
// the names of the rpers, 
// leftName then Rightname
